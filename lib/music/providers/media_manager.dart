...
import 'package:cuoiky_leduyminhduong/music/utils/history.dart';
import 'package:cuoiky_leduyminhduong/music/utils/lyrics.dart';
  ...
  Future<void> playRadio(item) async {
    String? stationId = await SaavnAPI().createRadio(
      names: item['more_info']['featured_station_type'].toString() == 'artist'
          ...
          : [item['id'].toString()],
      language: item['more_info']['language']?.toString() ?? 'vietnamese',
