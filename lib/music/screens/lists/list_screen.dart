...
import 'package:cuoiky_leduyminhduong/music/api/extensions.dart';
import 'package:cuoiky_leduyminhduong/music/api/ytmusic.dart';
import 'package:cuoiky_leduyminhduong/music/components/playlist_album_header.dart';
...
class _ListScreenState extends State<ListScreen> {
  ...
  sort({String param = 'title'}) {
    if (songs.isEmpty || songs[0][param] == null) return;
    if (ascending) {
